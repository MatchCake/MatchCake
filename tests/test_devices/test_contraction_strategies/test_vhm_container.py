...
class TestVhmContainer:
    ...
    def test_vh_matchgates_container_add(self, new_op):
    ...
    def test_vh_matchgates_container_try_add(self, new_op0, new_op1, crossing_wires):
        strategy = get_contraction_strategy("neighbours")
        container = strategy.get_container()
    ...
    def test_vh_matchgates_container_contract_single_op(self, op):
        strategy = get_contraction_strategy("neighbours")
        container = strategy.get_container()
        container.add(op)
        np.testing.assert_allclose(
    ...
    def test_vh_matchgates_container_contract_single_line(self, line_operations):
        strategy = get_contraction_strategy("neighbours")
        container = strategy.get_container()
    ...
    def test_vh_matchgates_container_contract_single_column(self, column_operations):
        strategy = get_contraction_strategy("neighbours")
        container = strategy.get_container()
        assert container.contract() is None
    ...
    def test_vh_matchgates_container_try_add_sptm(self, new_op0, new_op1, crossing_wires):
        strategy = get_contraction_strategy("neighbours")
        container = strategy.get_container()
        container.add(new_op0)
        if crossing_wires:
