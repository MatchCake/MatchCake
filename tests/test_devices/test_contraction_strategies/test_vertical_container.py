...
class TestVerticalContainer:
    ...
    def test_vert_matchgates_container_contract_single_op(self, op):
    ...
    def test_vert_matchgates_container_contract_single_column(self, column_operations):
        strategy = get_contraction_strategy("vertical")
        container = strategy.get_container()
    ...
    def test_vert_matchgates_container_contract_line_column(self, operations):
        strategy = get_contraction_strategy("vertical")
        container = strategy.get_container()
        assert container.contract() is None
    ...
    def test_vert_matchgates_container_contract_line_column_probs(self, operations):
        all_wires = set(wire for op in operations for wire in op.wires)
    ...
    def test_multiples_matchgate_probs_with_nif_vertical(self, params_list, n_wires):
    ...
    def test_multiples_matchgate_probs_with_qubits_device_vertical(self, params_list, n_wires):
        all_wires = np.arange(n_wires)
