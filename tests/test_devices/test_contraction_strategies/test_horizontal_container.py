...
class TestHorizontalContainer:
    ...
    def test_horizontal_matchgates_container_contract_single_op(self, op):
    ...
    def test_horizontal_matchgates_container_contract_crossing_ops(self, operations):
        strategy = get_contraction_strategy("horizontal")
        container = strategy.get_container()
    ...
    def test_horizontal_matchgates_container_contract_crossing_ops_probs(self, operations):
    ...
    def test_horizontal_matchgates_container_contract_single_column(self, column_operations):
        strategy = get_contraction_strategy("horizontal")
        container = strategy.get_container()
        assert container.contract() is None
    ...
    def test_horizontal_matchgates_container_contract_single_line_probs(self, line_operations):
    ...
    def test_horizontal_matchgates_container_contract_single_column_probs(self, operations):
        all_wires = set(wire for op in operations for wire in op.wires)
        nif_device = init_nif_device(wires=all_wires, contraction_method=None)
        nif_device_contracted = init_nif_device(wires=all_wires, contraction_method="horizontal")
    ...
    def test_horizontal_matchgates_container_contract_line_column_probs(self, operations):
        all_wires = set(wire for op in operations for wire in op.wires)
        nif_device = init_nif_device(wires=all_wires, contraction_method=None)
        nif_device_contracted = init_nif_device(wires=all_wires, contraction_method="horizontal")
    ...
    def test_multiples_matchgate_probs_with_nif_horizontal(self, params_list, n_wires):
