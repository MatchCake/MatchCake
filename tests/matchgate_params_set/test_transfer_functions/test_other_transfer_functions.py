...
def test_identity_params_to(__from_params: MatchgateParams):
    ...
    assert (
        to_params == __from_params
    ), f"Transfer function from {type(__from_params)} to {type(__from_params)} failed."
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for _to_cls in (
            [MatchgatePolarParams]
            if not MatchgatePolarParams.ALLOW_COMPLEX_PARAMS
            else []
        )
        + (
            [MatchgateComposedHamiltonianParams]
...
@pytest.mark.parametrize(
    ...
    [
        (
            MatchgateStandardHamiltonianParams(
                u0=0.0, u1=0.0, u2=0.0, u3=0.0, u4=0.0, u5=0.0, u6=0.0, u7=0.0
            ),
            MatchgateStandardParams(a=1, b=0, c=0, d=1, w=1, x=0, y=0, z=1),
        ),
        (
            MatchgateStandardHamiltonianParams(
                u2=np.pi / 2, u3=-np.pi / 2, u4=-np.pi / 2, u5=np.pi / 2, u7=np.pi
            ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            MatchgateComposedHamiltonianParams(
                n_x=0.0, n_y=0.0, n_z=0.0, m_x=0.0, m_y=0.0, m_z=0.0
            ),
...
def test_composed_hamiltonian_to_polar(
    __from_params: MatchgateComposedHamiltonianParams, __to_params: MatchgatePolarParams
):
...
def test_standard_hamiltonian_to_polar(
    __from_params: MatchgateStandardHamiltonianParams, __to_params: MatchgatePolarParams
):
...
@pytest.mark.parametrize(
    "__from_params",
    [MatchgateStandardParams.random() for _ in range(N_RANDOM_TESTS_PER_CASE)],
)
...
def test_polar_to_standard_hamiltonian(
    __from_params: MatchgatePolarParams, __to_params: MatchgateStandardHamiltonianParams
):
...
def test_hamiltonian_coefficients_to_standard_hamiltonian(
    ...
    to_params = transfer_functions.hamiltonian_coefficients_to_standard_hamiltonian(
        __from_params
    )
    assert (
        to_params == __to_params
...
def test_hamiltonian_coefficients_to_standard_hamiltonian_back_and_forth(
    ...
    _from_params = transfer_functions.standard_hamiltonian_to_hamiltonian_coefficients(
        to_params
    )
    assert _from_params == __from_params
...
def test_standard_hamiltonian_to_hamiltonian_coefficients_back_and_forth(
    ...
    to_params = transfer_functions.standard_hamiltonian_to_hamiltonian_coefficients(
        __from_params
    )
    _from_params = transfer_functions.hamiltonian_coefficients_to_standard_hamiltonian(
        to_params
    )
    _to_params = transfer_functions.standard_hamiltonian_to_hamiltonian_coefficients(
        _from_params
    )
    assert to_params == _to_params
...
def test_composed_hamiltonian_to_standard_hamiltonian(
    ...
    to_params = transfer_functions.composed_hamiltonian_to_standard_hamiltonian(
        __from_params
    )
    assert (
        to_params == __to_params
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            MatchgateComposedHamiltonianParams(
                n_x=1.0, n_y=1.0, n_z=1.0, m_x=1.0, m_y=1.0, m_z=1.0
            ),
            MatchgateHamiltonianCoefficientsParams(
                h0=0.5, h1=0.5, h2=0.0, h3=0.5, h4=0.0, h5=0.0
            ),
        ),
        (
            MatchgateComposedHamiltonianParams(
                n_x=1.0, n_y=1.0, n_z=1.0, m_x=2.0, m_y=2.0, m_z=2.0
            ),
            MatchgateHamiltonianCoefficientsParams(
                h0=3.0 / 4,
                h1=3.0 / 4,
        ...
        (
            MatchgateComposedHamiltonianParams(
                n_x=2.0, n_y=2.0, n_z=2.0, m_x=1.0, m_y=1.0, m_z=1.0
            ),
            MatchgateHamiltonianCoefficientsParams(
        ...
        (
            MatchgateComposedHamiltonianParams(
                n_x=1.0, n_y=1.0, n_z=1.0, m_x=0.0, m_y=0.0, m_z=0.0
            ),
            MatchgateHamiltonianCoefficientsParams(
        ...
        (
            MatchgateComposedHamiltonianParams(
                n_x=0.0, n_y=0.0, n_z=0.0, m_x=1.0, m_y=1.0, m_z=1.0
            ),
            MatchgateHamiltonianCoefficientsParams(
                h0=1.0 / 4,
                h1=1.0 / 4,
        ...
        (
            MatchgateComposedHamiltonianParams(
                n_x=0.0, n_y=0.0, n_z=0.0, m_x=1.0, m_y=1.0, m_z=1.0, epsilon=10
            ),
            MatchgateHamiltonianCoefficientsParams(
                h0=1.0 / 4,
                h1=1.0 / 4,
...
def test_composed_hamiltonian_to_hamiltonian_coefficients(
    ...
    to_params = transfer_functions.composed_hamiltonian_to_hamiltonian_coefficients(
        __from_params
    )
    assert (
        to_params == __to_params
...
def test_polar_to_composed_hamiltonian(
    __from_params: MatchgatePolarParams, __to_params: MatchgateComposedHamiltonianParams
):
...
def test_hamiltonian_coefficients_to_composed_hamiltonian(
    ...
    to_params = transfer_functions.hamiltonian_coefficients_to_composed_hamiltonian(
        __from_params
    )
    assert (
        to_params == __to_params
...
def test_standard_hamiltonian_to_composed_hamiltonian(
    ...
    to_params = transfer_functions.standard_hamiltonian_to_composed_hamiltonian(
        __from_params
    )
    assert (
        to_params == __to_params
...
def test_standard_to_polar_in_batch(
