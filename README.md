...
quantum unitaries that are parity-preserving and operate on nearest-neighbor qubits. Due to these constraints, matchgates are simulable classically in polynomial time.
