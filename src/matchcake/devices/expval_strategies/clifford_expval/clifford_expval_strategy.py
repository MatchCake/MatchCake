...
class CliffordExpvalStrategy(ExpvalStrategy):
    ...
    def __call__(self, state_prep_op: StatePrepBase, observable: Operator, **kwargs) -> TensorLike:
        ...
        (majorana_coeffs, hamiltonian_coeffs, global_sptm, majorana_indices, expvals) = self._prepare_summands(
            state_prep_op, observable, global_sptm
        )
    ...
    def _compute_sum(self, majorana_coeffs, coeffs, global_sptm, majorana_indices, expvals):
        transition_tensor = self._create_transition_tensor(global_sptm, majorana_indices)
    ...
    def _prepare_summands(
        ...
        return majorana_coeffs, hamiltonian.coeffs, global_sptm, majorana_indices, expvals
